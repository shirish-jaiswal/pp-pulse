...
export default function QuickFilterCreator({ fieldKey, value, className = "" }: QuickFilterCreatorProps) {
  ...
  const handleCreateFilter = (operatorType: "is_one_of" | "is_not_one_of") => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group/btn relative flex h-[22px] w-[22px] cursor-pointer items-center justify-center rounded-sm bg-slate-100 text-slate-600 transition-all duration-150 ease-out hover:bg-emerald-600 hover:text-white active:scale-90"
      >
      ...
      <button
        ...
        className="group/btn relative flex h-[22px] w-[22px] cursor-pointer items-center justify-center rounded-sm bg-slate-100 text-slate-600 transition-all duration-150 ease-out hover:bg-rose-600 hover:text-white active:scale-90"
      >
