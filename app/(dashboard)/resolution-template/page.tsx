...
import { ResolutionTable } from "@/features/resolution-template/components/resolution-table/resolution-table";
...
export default function ResolutionTemplateManager() {
  ...
  const { data: resolutions = [], isLoading: loading } = useResolutionTemplates();
