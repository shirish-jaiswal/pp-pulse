...
export function DateTimePanel({
  ...
  // Added a ref to the container panel in case explicit outside tracking is needed
  ...
  const handleSelectDate = (selectedLocalDate: Date | undefined) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start border rounded-md p-3 w-fit bg-popover">
        ...
        <div className="flex flex-col gap-3 h-75 w-full sm:w-42.5">
          <Field>
          ...
          <div className="flex-1 overflow-y-auto pr-1 border rounded-md p-1 gap-1 flex flex-col scrollbar-thin max-h-47.5">
            {timeSlots.map((slot) => {
