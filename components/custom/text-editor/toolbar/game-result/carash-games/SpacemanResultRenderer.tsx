                    ...
                    <tr>
                      ...
                      <td valign="top" style={{ width: "50%", padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", backgroundColor: "#ffffff" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px" }}>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>cashout opted at:</span> 
                            <span style={{ fontFamily: "monospace", fontWeight: "bold", color: bet.hc.isOptedIn ? "#4338ca" : "#64748b" }}>{bet.hc.optedAt}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Requested Multiplier:</span> 
                            <span style={{ fontFamily: "monospace" }}>{bet.hc.target}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Wager Allocation:</span> 
                            <span>IDR {bet.hc.allocation.toLocaleString()}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Executed Mult:</span> 
                            <span style={{ fontFamily: "monospace", fontWeight: "bold", color: bet.hc.isBusted ? "#ef4444" : "#4338ca" }}>{bet.hc.multiplier}</span>
                          </div>
                      ...
                      <td valign="top" style={{ width: "50%", padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", backgroundColor: "#ffffff" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "4px", fontSize: "11px" }}>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>cashout opted at:</span> 
                            <span style={{ fontFamily: "monospace", fontWeight: "bold", color: bet.co.isOptedIn ? "#6d28d9" : "#ef4444" }}>{bet.co.optedAt}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Requested Multiplier:</span> 
                            <span style={{ fontFamily: "monospace" }}>{bet.co.target}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Wager Allocation:</span> 
                            <span>IDR {bet.co.allocation.toLocaleString()}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <span style={{ color: "#64748b" }}>Executed Mult:</span> 
                            <span style={{ fontFamily: "monospace", fontWeight: "bold", color: bet.co.isBusted ? "#ef4444" : "#6d28d9" }}>{bet.co.multiplier}</span>
                          </div>
                          <div style={{ display: "flex", justifyContent: "space-between", marginTop: "6px", paddingTop: "4px", borderTop: "1px dashed #f1f5f9" }}>
